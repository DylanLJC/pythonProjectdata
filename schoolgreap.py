...
for l in province_id:
    header = ['名称', '省', '市', '县', '地址', '介绍', '985', '211', '软科排名', '学校类型', '学校属性', '特色专业',
              "2021分数线", "2020分数线", "2019分数线"]
    ...
    for i in dat:
        ...
        if len(unicodestr1) != 0:
            ...
            tap = (name, province_name, city_name, town_name, address, content, f985, f211, ruanke_rank, type_name,
                   school_nature_name, special, fen2021, fen2020, fen2019)
